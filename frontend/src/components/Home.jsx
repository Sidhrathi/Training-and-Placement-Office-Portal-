...
const notifications = [
  {
    ...
    message:
      "INR 20.71 LPA was offered to a BTech Petroleum Engineering student at Lachoo Memorial College of Science & Technology in 2024. Top recruiters included Larsen & Toubro, JK Lakshmi Cement, and Adani Group.",
    date: "2024-07-01",
  },
  {
    id: 2,
    ...
    <div className="home-container">
      ...
      <section className="hero-section mt-5">
        <div className="hero-image-container">
          <img
            src={collegeImage}
            alt="Lachoo Memorial College of Science & Technology Campus"
      ...
      <section className="about-section">
        ...
        <div className="about-content">
          <p>
            <strong>Employability is the key focus at Lachoo Memorial College of Science & Technology</strong>{" "}
            and is deeply embedded into all the programs that the College
            offers. The College has a dedicated placement cell that ensures
      ...
      <section className="vision-mission-section">
        <div className="vision-mission-container">
          <div className="vision-card">
            ...
            <h2>Vision</h2>
            <p>
              The Training and Placement Cell of Lachoo Memorial College of Science & Technology envisions
      ...
      <section className="cta-section">
        <div className="cta-overlay">
          ...
          <p>Join the Lachoo Memorial College of Science & Technology community and kickstart your career</p>
        ...
        <div className="contact-container">
          <div className="contact-info">
            <div className="contact-item">
              ...
              <p>Sector – A , Shastri Nagar Jodhpur </p>
