  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>Best Regards,<br>KLE Technological College Training and Placement Cell</p>
      </div>
      <div class="footer">
        <p>© ${new Date().getFullYear()} Lachoo Memorial of Science and Technology College. All rights reserved.</p>
      </div>
    </div>
  </body>
  </html>
